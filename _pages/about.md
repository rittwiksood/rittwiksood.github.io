...
Hello, I'm Rittwik. I am a PhD applicant and a Graduate student in ECE at Purdue University. I have undertaken relevant courses such as Wireless Communication Systems, Digital Communications, Convex Optimization, Artificial Intelligence, Random Variables and Stochiastic Process, Computer Communication Networks and Linear Programming. I am looking to widen my horizon in the field of Wireless Communication Systems, especially Next-G Systems / THz networks. I have also worked as a TA for 'Basic Electrical Networks' ECE 2K1 and Introduction to Digital System Design 'ECE270' and adjuged as a Best Graduate TA for two of the semesters.

I recently was a System Engineering Intern at Eutelsat OneWeb, McLean, Virginia, working on NR5G NTN Networks. I proposed a design for a new-gen NTN network for LEO satellite constellation network, implemented firmware and software stacks to emulate modem chips, enhancing simulation fidelity and reducing integration bottlenecks. I led cross-functional development team to create an in-house software environment team.
